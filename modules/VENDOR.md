...
|---|---|---|---|---|
| cpu-tv80 | Z80 (Guy Hutchison's Verilog translation of Daniel Wallner's T80). `tv80s.v`, `tv80n.v` and the SD-card test benches are removed; `rtl/z80_cpu.sv` is a copy of `tv80s.v` with the clock enable brought out. **One edit:** `` `define TV80_REFRESH `` at the top of `tv80_core.v` -- without it R never counts and `LD A,R` reads 0, and this game's enemies take their random numbers from R | https://github.com/hutch31/tv80 (`rtl/core`) | 66a131c38d05ef58b3d8c4f1507a72e6e4aa5d65 | MIT |
